...
> [conventional-changelog](https://github.com/ajoslin/conventional-changelog) [angular](https://github.com/angular/angular) preset with [emojis](http://www.webpagefx.com/tools/emoji-cheat-sheet/).

*:stuck_out_tongue_closed_eyes: Life is hard, give me a emoji!*
